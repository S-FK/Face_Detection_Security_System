...
def send_sms():
    acc="Afdsdfs4ff8ddjfg999affgjrm4tjrsfhi"
    token="afei45454kljhhhalfu48lafj890adjf"
    client=TwilioRestClient(acc,token)
    message=client.messages.create(to="+91-xxxxxxxxxx",from_="xxxxxxxxxxx",body="Logged In")
    print "Message sent!"
